...
wrUImainA1 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}a1sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}a1sub3.ui") \n',
    '        ) \n',
    '      ), # End of column (6 space) \n',
    '      column( \n',
...
wrUImainS3 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}s3sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}s3sub3.ui") \n',
    '        ),\n',
    '        br(), br(),\n',
...
wrUImainA2 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}a2sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}a2sub3.ui") \n',
    '        ) \n',
    '      ), # End of column (6 space) \n',
    '      column( \n',
...
wrUImainA3 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}a3sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}a3sub3.ui") \n',
    '        ) \n',
    '      ), # End of column (6 space) \n',
    '      column( \n',
...
wrUImainB1 <- function(prefix, ptsiz) {
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}b1sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}b1sub3.ui") \n',
    '        ), br(), br(), \n',
...
wrUImainB2 <- function(prefix) {
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}b2sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}b2sub3.ui") \n',
    '        ), br(), br(), \n',
...
wrUImainB3 <- function(prefix) {
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}b3sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}b3sub3.ui") \n',
    '        ), br(), br(), \n',
...
wrUImainS1 <- function(prefix, ptsiz, hasMultiSlides = FALSE) {
  ...
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}s1sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}s1sub3.ui") \n',
    '        ) \n',
    '      ), # End of column (6 space) \n',
    '      column( \n',
...
wrUImainS2 <- function(prefix, ptsiz, hasMultiSlides = FALSE) {
  ...
  glue::glue(
    ...
    '          hr(), \n',
    '          p(em("Optional 2nd filter (AND logic):")), \n',
    '          selectInput("{prefix}s2sub3", "2nd filter column:", \n',
    '                      choices = c("(none)", {prefix}conf[grp == TRUE]$UI), \n',
    '                      selected = "(none)"), \n',
    '          uiOutput("{prefix}s2sub3.ui") \n',
    '        ) \n',
    '      ), # End of column (6 space) \n',
    '      column( \n',
